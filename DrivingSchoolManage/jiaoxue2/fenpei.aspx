<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="fenpei.aspx.cs" Inherits="JXGL.jiaoxue2.fenpei" %>
...
<table width="98%" height="62" border="0" align="left" cellpadding="3" cellspacing="1" class="table">
  <tr class="back"> 
    <td  colspan="2" class="xingmu">教练分配    
     <td align="right">
         ...
         <tr style="display:">
           ...
           <td align="left" style="height: 25px" colspan="3">
               ...
               <asp:SqlDataSource ID="SqlDataSource2" runat="server" 
                   ConnectionString="<%$ ConnectionStrings:JXGLConnectionString3 %>" 
                   SelectCommand="SELECT [jname] FROM [J]" 
