<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="yueche.aspx.cs" Inherits="JXGL.jiaoxue2.yueche" %>
...
<table width="98%" height="62" border="0" align="left" cellpadding="3" cellspacing="1" class="table">
  <tr class="back"> 
    <td  colspan="2" class="xingmu">约车登记
     <td align="right">
         ...
         <tr>
           ...
           <td align="left">
               <asp:DropDownList ID="DropDownList1" runat="server" 
                   DataSourceID="SqlDataSource2" DataTextField="jname" DataValueField="jname">
               </asp:DropDownList>
               <asp:SqlDataSource ID="SqlDataSource2" runat="server" 
                   ConnectionString="<%$ ConnectionStrings:JXGLConnectionString4 %>" 
                   onselecting="SqlDataSource2_Selecting" SelectCommand="SELECT [jname] FROM [J]">
               </asp:SqlDataSource>
           </td>
         </tr>
         <tr>
            <td style="height: 25px">约车时间</td>
           <td align="left" style="height: 25px">
             <asp:TextBox ID="TextBox5" runat="server" Width="150px" CssClass="Wdate"></asp:TextBox>
               <asp:CompareValidator ID="CompareValidator1" runat="server" 
                 ErrorMessage="日期格式必须为yyyy-mm-dd" Display="Dynamic" ControlToValidate="TextBox5" Operator="DataTypeCheck" Type="Date"></asp:CompareValidator>
                </td>
             <td>约车地点</td>
           <td align="left">
