<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="test.aspx.cs" Inherits="JXGL.test.yuekao" %>
...
<table width="98%" height="62" border="0" align="left" cellpadding="3" cellspacing="1" class="table">
  <tr class="back"> 
    <td  colspan="2" class="xingmu">约考登记
     <td align="right">
     <a href ="/kaoshi.aspx" target=_self>返回上一菜单</a>
    </td>
  </tr>
  <tr class="back">
