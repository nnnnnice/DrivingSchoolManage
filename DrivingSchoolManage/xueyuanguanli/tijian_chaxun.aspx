<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="tijian_chaxun.aspx.cs" Inherits="JXGL.xueyuanguanli.tijian_chaxun" %>
...
<table width="98%" height="62" border="0" align="center" cellpadding="3" cellspacing="1" class="table">
  <tr class="back"> 
    <td  colspan="2" class="xingmu">体检查询
     <td align="right">
            ...
            AllowSorting="True" PageSize="12" onrowdatabound="GridView1_RowDataBound" 
               onselectedindexchanged="GridView1_SelectedIndexChanged">
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="lsight" HeaderText="左视力" />
                            <asp:BoundField DataField="rsight" HeaderText="右视力" />
                            <asp:BoundField DataField="semang" HeaderText="辨色力" />
                            <asp:BoundField DataField="hear" HeaderText="听力" />
                            <asp:BoundField DataField="leg" HeaderText="上肢" />
                            <asp:BoundField DataField="limb" HeaderText="下肢" />
                            <asp:BoundField DataField="body" HeaderText="躯干" />
