<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="tuixue.aspx.cs" Inherits="JXGL.xueyuanguanli.tuixue" %>
...
<table width="98%" height="62" border="0" align="left" cellpadding="3" cellspacing="1" class="table">
  <tr class="back"> 
    <td  colspan="2" class="xingmu">学员退学    
     <td align="right">
  ...
  <tr class="back"> 
    ...
    <div style=" color:#fff; font-size:25px; text-align:center; font-family:幼圆; font-weight:bold;">学员退学</div>
       <table>
         <tr>
         ...
         <tr style="display:">
           <td style="height: 25px">退学记录</td>
           <td align="left" style="height: 25px" colspan="3">
             <asp:TextBox ID="Textbox3" runat="server" TextMode="MultiLine" Rows="5" Width="380px"></asp:TextBox></td>
         </tr>
         <tr>
