<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="yonghu.aspx.cs" Inherits="JXGL.yonghu" %>
...
<table cellSpacing=0 cellPadding=0 width="100%" border=0>
  <tr bgColor=#1c5db6 height=4>
    ...
    <p>
      <a href ="users/add.aspx" target=_self>用户添加</a>
      <a href ="users/guanli.aspx" target=_self>用户管理</a>
